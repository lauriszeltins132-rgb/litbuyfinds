...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/litbuy-coupon-code", destination: "/litbuy-coupons", permanent: true },
      ...
      { source: "/litbuy-discount-code", destination: "/litbuy-coupons", permanent: true },
      ...
      { source: "/litbuy-coupons-2026", destination: "/litbuy-coupons", permanent: true },
      { source: "/best-litbuy-coupon", destination: "/litbuy-coupons", permanent: true },
      { source: "/best-litbuy-coupons", destination: "/litbuy-coupons", permanent: true },
      {
