...
function buildParagraphs() {
  ...
  return [
    `LitBuy Finds is the authority website for rep product discovery — a searchable database of ${stats.totalFindsLabel} indexed finds with ${stats.qcFindsLabel} QC-linked listings, prices, and one-click agent links. Whether you are hunting sneaker finds, clothing finds, streetwear, or spreadsheet-style rep browsing, everything is organized by brand, category, and collection.`,
    "As a clothing and sneaker discovery platform, LitBuy Finds turns raw spreadsheet rows into proper landing pages you can search, filter, and share. QC photo references help you compare batches before ordering. The LitBuy spreadsheet guide and Latest Finds hub sit at the center of the catalog — with category databases for sneakers, hoodies, jackets, and streetwear.",
    ...
    "LitBuy is the recommended agent on this site because of shipping discounts, a polished app, and reliable QC workflows — but you are not locked in. USFans, GTBuy, BoonBuy, OopBuy, Kakobuy, and HipoBuy are fully supported on every product page. Switch agents in the header before you click Buy; the link rebuilds automatically for the same listing.",
    ...
    "If you are new to agent buying, start with our beginner guide — then browse Trending or Editor's Picks on the homepage. Experienced buyers can jump straight to brand hubs (Nike, Jordan, Moncler, Chrome Hearts, Stussy, Dior, Balenciaga, Louis Vuitton) or category find pages for sneakers, hoodies, jackets, and streetwear. The goal is simple: less time hunting spreadsheets, more time picking finds you will actually ship.",
  ] as const;
}
        ...
        <details className="group rounded-2xl border border-border bg-surface/25 p-6 sm:p-8">
          <summary className="cursor-pointer list-none [&::-webkit-details-marker]:hidden">
            <h2 className="text-xl font-black sm:text-2xl">
              The LitBuy Finds Product Discovery Database
            </h2>
